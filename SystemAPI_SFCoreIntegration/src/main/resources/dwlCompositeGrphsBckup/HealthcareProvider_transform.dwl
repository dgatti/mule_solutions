...
// ( if (!isEmpty(item.PractitionerId))   
//	 [{
//      "url" : '/services/data/v53.0/sobjects/Contact/External_Id__c/' ++ item.PractitionerId,
//      "method": "GET",
//      "referenceId": 'PracContact_' ++ index
//   }] else   [])
//++
  ...
  [{
      ...
      "body" : {
       ...
       // ("PractitionerId": "@{PracContact_" ++ index ++ '.Id}') if (!isEmpty(item.PractitionerId)),
        
        //("AccountId": {"External_Id__c": item.AccountId }) if (!isEmpty(item.AccountId)),
